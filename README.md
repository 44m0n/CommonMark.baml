...
A CommonMark 0.31.2 parser in [BAML](https://docs.boundaryml.com): Markdown → typed AST → HTML. No GFM in this tree. The engine is rule-table driven so a later dialect can append block/inline starts without rewriting phase 1/2.
...
- `ns_inline/` — phase 2, `commonmark_inline_rules()`
